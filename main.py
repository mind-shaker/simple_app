            ...
            messages = [
                {
                    ...
                    Return the English word 'yes' if the phrase indicates agreement, or 'no' if it does not. 
                    Return exactly yes or no as plain text, without any quotes or formatting.'
                }
            ]
